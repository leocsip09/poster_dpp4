...
Figure \ref{fig-dpp4} shows the final stable state of the DPP4 and Figure \ref{fig:barplot} shows the RMSD and RMSF of this equilibrium showing an excellent stable conformation. Figure \ref{fig:RMSD} shows that the stable state of the protein (RMSF).
...
\vspace{-1.0cm}
\captionof{figure}{DPP4 500ns equilibrium NPT.}
\label{fig:dpp4_multiplot}
\end{figure}
\vspace{-1.0cm}
