...
\begin{center}
  \includegraphics[width=0.9\columnwidth]{DPP4.png}
...
\begin{center}
  \includegraphics[width=0.8\columnwidth]{Compounds.png}
...
Figure \ref{fig:dpp4_pockets} shows the main binding pockets of DPP4 identified after the blind docking simulations. Once the ten best-ranked ligands were obtained, the five compounds with the most favorable binding affinities (L1--L5) were selected for a detailed analysis of their binding sites. Visual inspection and pocket characterization were performed using ChimeraX, allowing the identification of the binding cavity each ligand occupies. The docking results revealed that several ligands occupied the same binding pocket, suggesting the presence of energetically favorable regions within the DPP4 structure. Ligands L2 (rutin) and L3 ($\alpha$-muurolene) were found to bind within the same cavity, characterized mainly by the residues Trp201, Pro257, Asp663, Glu205, and His740. Similarly, ligands L4 (marmesinin) and L5 (flavone derivative) also docked into a common pocket formed by Glu232, Asp200, Asp230, Pro264, and Thr231. In contrast, L1 (isoquercitrin) occupied a distinct binding cavity involving residues Phe228, Glu232, Thr199, Asp200, and Pro255. Although this ligand showed the highest binding affinity in the docking stage.
...
The structural stability of the DPP4--ligand complexes was evaluated through root mean square deviation (RMSD) and root mean square fluctuation (RMSF) analyses over 100 ns of molecular dynamics simulations. RMSD provides information on the overall conformational stability of the protein backbone during the simulation, while RMSF describes the flexibility of individual residues around their average positions.

As shown in Figure \ref{fig:RMSD}, most complexes reached a stable RMSD profile after an initial equilibration period, indicating that the protein maintained a stable global conformation in the presence of the majority of the ligands. However, the complex formed with L1 (isoquercitrin) showed a noticeable increase in RMSD between 40 ns and 60 ns, suggesting a transient destabilization of the protein structure during this time interval. After this period, the system seems to recover and reaches a new equilibrium state.

The RMSF profiles presented in Figure \ref{fig:RMSF} indicate moderate residue-level fluctuations along the protein chain, consistent with a stable folded structure throughout the simulations. Overall, the molecular dynamics results support that, except for the temporary perturbation observed with L1, the remaining ligand-bound complexes preserved the structural integrity of DPP4 during the simulation timeframe.
...
The reactivity of each ligand was analyzed and as shown in Figure \ref{fig:mmpbsa_stacked} and more specific in Table \ref{table}. L5 (a flavone derivative) displayed the most negative energy out of all of them, meaning that it is the most reactive. L4 (marmesinin) had the second best reactivity, with a very small difference from L5.

The binding free energy of the DPP4--ligand complexes was further evaluated using MMPBSA calculations. The energy decomposition results are presented in Figure \ref{fig:mmpbsa_stacked}, while the corresponding total binding free energies ($\Delta G_{\mathrm{bind}}$) are summarized in Table \ref{table}. These analyses provide a estimation of ligand affinity by accounting for van der Waals, electrostatic, polar solvation, and nonpolar solvation contributions.

Among the evaluated compounds, L5 (flavone derivative) exhibited the most favorable binding free energy ($\Delta G_{\mathrm{bind}} = -42.68$ kcal/mol), indicating the strongest interaction with DPP4. L4 (marmesinin) showed the second most favorable binding profile, with a binding free energy of $-40.07$ kcal/mol, differing only slightly from that of L5. This close energetic proximity suggests that both ligands establish similarly stable interactions within the DPP4 binding pocket.

The remaining ligands displayed progressively less favorable binding free energies, with $\alpha$-muurolene (L3) showing moderate affinity, followed by rutin (L2) and isoquercitrin (L1), which presented weaker interactions with the protein. Overall, the MMPBSA results are consistent with the docking and molecular dynamics analyses, reinforcing L5 and L4 as the most promising candidates in terms of binding strength.
...
Ligand   &  $\Delta G_{\mathrm{bind}}$ \\\midrule
